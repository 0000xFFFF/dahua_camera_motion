...
krzo:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_REL -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -D ENABLE_MOTION_ZOOM_LARGEST=1 -D SLEEP_MS_DRAW_DETECTED=80 $(LIBS) $(FILES) -o $(EXEC)
