...
r1zo:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_CIRC -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -D SLEEP_MS_DETECTED=80 -D ENABLE_TOUR=1 -D ENABLE_MOTION_ZOOM_LARGEST=1 $(LIBS) $(FILES) -o $(EXEC)
...
# single, motion slow, draw fast, tour
s1o:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_SINGLE -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -SLEEP_MS_DETECTED=80 -D ENABLE_TOUR=1 $(LIBS) $(FILES) -o $(EXEC)
