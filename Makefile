...
r1:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_CIRC -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=65 -D ENABLE_TOUR=1 $(LIBS) $(FILES) -o $(EXEC)

# king, circ, motion slow, draw fast, tour, zoom
r1z:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_CIRC -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=65 -D ENABLE_TOUR=1 -D ENABLE_MOTION_ZOOM_LARGEST=1 $(LIBS) $(FILES) -o $(EXEC)

# king, circ, motion slow, draw optimized, tour, zoom
r1zo:
