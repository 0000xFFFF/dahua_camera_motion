...
# tour, king, rel, motion slow, draw fast
tkr:
...
# tour, king, rel, motion slow, draw fast, zoom
tkrz:
...
# tour, king, rel, motion slow, draw optimized, zoom
tkrzo:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_REL -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -D SLEEP_MS_DRAW_DETECTED=80 -D ENABLE_TOUR=1 -D ENABLE_MOTION_ZOOM_LARGEST=1 $(LIBS) $(FILES) -o $(EXEC)

# tour, king, circ, motion slow, draw fast
tkc:
...
# tour, king, circ, motion slow, draw fast, zoom
tkcz:
...
# tour, king, circ, motion slow, draw optimized, zoom
tkczo:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_CIRC -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -D SLEEP_MS_DRAW_DETECTED=80 -D ENABLE_TOUR=1 -D ENABLE_MOTION_ZOOM_LARGEST=1 $(LIBS) $(FILES) -o $(EXEC)

# single, motion slow, draw fast, tour
s:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_SINGLE -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=80 -D ENABLE_TOUR=1 $(LIBS) $(FILES) -o $(EXEC)

# single, motion slow, draw fast, tour
so:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_SINGLE -D SLEEP_MS_MOTION=300 -D SLEEP_MS_DRAW=300 -D SLEEP_MS_DRAW_DETECTED=80 -D ENABLE_TOUR=1 $(LIBS) $(FILES) -o $(EXEC)
