...
ignore:
	$(GCC) $(ARGS) $(DEBUG_ARGS) -D ENABLE_INFO=0 -D ENABLE_MINIMAP=0 -D ENABLE_MINIMAP_FULLSCREEN=1 -D ENABLE_IGNORE_CONTOURS=1 -D DEFAULT_WIDTH=CROP_WIDTH -D DEFAULT_HEIGHT=CROP_HEIGHT $(LIBS) $(FILES) -o $(EXEC)
#
# ==[ BENCHING CPU
#
