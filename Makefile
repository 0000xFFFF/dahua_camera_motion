...
krzod:
	$(GCC) $(ARGS) $(DEBUG_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_REL -D ENABLE_MOTION_ZOOM_LARGEST=1 -D SLEEP_MS_FRAME=100 -D SLEEP_MS_DRAW=100 -D SLEEP_MS_MOTION=100 $(LIBS) $(FILES) -o $(EXEC)
...
krzo2:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_REL -D ENABLE_MOTION_ZOOM_LARGEST=1 -D SLEEP_MS_FRAME=100 -D SLEEP_MS_DRAW=300 -D SLEEP_MS_DRAW_DETECTED=100 -D SLEEP_MS_MOTION=100 $(LIBS) $(FILES) -o $(EXEC)
