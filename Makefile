...
krzo:
	$(GCC) $(ARGS) $(RELEASE_ARGS) -D DISPLAY_MODE=DISPLAY_MODE_KING -D KING_LAYOUT=KING_LAYOUT_REL -D ENABLE_MOTION_ZOOM_LARGEST=1 -D SLEEP_MS_FRAME=50 -D SLEEP_MS_DRAW=80 -D SLEEP_MS_MOTION=100 $(LIBS) $(FILES) -o $(EXEC)
